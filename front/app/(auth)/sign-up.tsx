    ...
    const onPressVerify = async () => {
        ...
        try {
            ...
            if (completeSignUp.status === "complete") {
                ...
                console.log("Sending user data to backend:", userData); // Log the user data

                try {
                    const response = await fetch(
                        "https://9334-102-169-172-240.ngrok-free.app/api/v1/auth/sync-user",
                        {
                            method: "POST",
                            headers: {
                    ...
                    Alert.alert("Sync Error", "Failed to sync user data with backend.");
                }
            } else {
                setVerification({
                    ...verification,
            ...
            <ScrollView className="flex-1 bg-white">
                <View className="flex-1 bg-white">
                    <View className="relative w-full h-[250px]">
                        <Image source={images.logo} className="z-0 w-full h-[250px]" />
